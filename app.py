...
app = Flask(__name__)
DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ahpc_civil4.db')
...
def exportar_pdf():
    ...
    elements = [
        ...
        Paragraph("Juzgado Civil Capital 4° Nominación · Índice Onomástico de Expedientes (1898–1925)", sub),
        Spacer(1, .2*inch),
    ]
    ...
    t.setStyle(TableStyle([
        ...
        ('TEXTCOLOR',     (0,0), (-1,0), colors.HexColor('#c8a8e8')),
        ...
        ('ROWBACKGROUNDS',(0,1), (-1,-1), [colors.white, colors.HexColor('#f3ecfd')]),
    ...
    resp.headers['Content-Disposition'] = 'inline; filename=ahpc_civil4.pdf'
    return resp
